...
We expect children to be a distinguishing feature as raising child would definitely change almost every aspects of an adult's life with traveling included. In all ways of transportation, people with two or more children take up highest proportion in the car category. It's reasonable because one can imagine the trouble of taking subway with two kids but it's also possible that the result coming from the reciprocal effects of other variables. For example, those who live longer and own their house are also likely to buy a car and having more children in New York City. Young people will have significant disadvantages in terms of their wealth accumulation and years of living in the city. Further understanding of the phenomenon requires a deeper analysis to control the effect of other variables. 
...
Now we can observed the association more clearly. People with a higher tendency to use for-hired vehicle are also willing to choose takeout delivery service. That's probably a reason why Uber also develop Uber Eats as the customers are somehow overlapped.
...
Transportation is naturally a topic highly related to space and geography elements. In this part, we extract the transportation of highest proportion in people's choices for each Zipcode and derive the "favorite transportation by Zipcode" variable. 

From the choropleth, we can see that a majority of blocks in New York City choose Subway as their favorite way of transportation, which include most areas of Queens and Brooklyn, Manhattan Uptown and the South Bronx. From the New York City subway system map we can see these are also the areas where subway lines are constructed in high density. 
...
Interestingly, people living in downtown of Manhattan and some parts of Brooklyn choose walking as their favorite way of transportation. It may be related to the density of commercial activities so that people do not have to travel long distance to meet their daily needs. As they live in the center of the city, it's unnecessary to take subway or drive a car to their workplaces.
...
As a result of difference in infrastructure construction and urban area function, people in different boroughs and locations of the city form different preference for transportation.
